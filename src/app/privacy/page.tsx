  ...
  return (
    <div className="section">
      <div className="container-wide max-w-3xl prose-content">
        ...
        <p>When you contact us or place an order, we collect your name, email, phone number, country, and inquiry details. We do not store credit card data on our servers.</p>
