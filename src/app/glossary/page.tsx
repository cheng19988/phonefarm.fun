...
export const metadata = buildMetadata({
  ...
  description:
    "Definitions of phone farm box, phone farm equipment, Android device farm hardware, mobile device farm, motherboard cluster, and factory-direct supplier terms. By PhoneFarm Fun.",
  path: "/glossary",
});
