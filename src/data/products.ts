...
export const PRODUCT_SEEDS: ProductSeed[] = [
  ...
  p(
    "iphone-phone-farm",
    "10–20 Node Multi-Device Lab Rack",
    "Standard Deployment",
    "Chassis for QA teams using customer-supplied smartphones — centralized power, cooling, and cable routing for mixed-device test labs.",
    IMAGES.iphoneFarm,
    1280,
    5,
    {
      description:
        "Lab rack chassis sized for 10–20 customer-supplied smartphones. We build the mounting, power rails, USB routing, and network baseline — you provide the devices for your QA or compatibility testing workflow. Suitable for Android-focused labs or teams also running macOS control workflows with their own iPhones.",
      features: [
        "10–20 device positions (configurable tray layout)",
        "Centralized charging and cable routing",
        "Lab network segment baseline",
        "Compatible with standard ADB / Xcode control workflows",
        "Pre-shipment slot and power verification",
      ],
      specs: {
        "Device Type": "Customer-supplied smartphones (not included)",
        ...
        "Remote Operation": "ADB or macOS lab workflow (customer devices)",
        "Typical Use": "Mixed-device QA, compatibility testing",
        "Customization": "Tray spacing confirmed before build",
      },
      scenarios: [
        "Multi-device app compatibility testing",
        "QA lab for mobile engineering teams",
        "Long-running stability tests on physical hardware",
        "Secondary platform testing alongside Android clusters",
      ],
      accessories: [
        "Multi-device rack chassis",
        "Charging and hub cabling",
        "Network router baseline (optional)",
        "Setup documentation",
      ],
      delivery: [
        "Per-slot power verification (without customer devices)",
        "Export packaging",
