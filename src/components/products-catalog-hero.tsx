...
export function ProductsCatalogHero() {
  ...
  return (
    <section className="catalog-hero catalog-hero--light">
      <div className="catalog-hero-bg-pattern catalog-hero-bg-pattern--light" aria-hidden />
      <div className="container-wide relative z-10 py-8 md:py-10">
        <div className="grid lg:grid-cols-[0.92fr_1.08fr] gap-8 lg:gap-10 items-center">
          <div>
            ...
            <h1 className="font-display text-3xl sm:text-4xl lg:text-[2.65rem] font-bold text-zinc-900 leading-tight tracking-tight mb-4">
              Phone Farm Hardware Catalog
            </h1>
            <p className="text-zinc-600 text-sm md:text-base leading-relaxed max-w-xl mb-5">
          ...
          <div className="grid grid-cols-[1.15fr_0.85fr] gap-3">
            <Link href={main.href} className="catalog-hero-stage catalog-hero-stage--main catalog-hero-stage--product row-span-2 group">
              <Image
                src={main.src}
                alt={main.label}
                fill
